            ...
            >
              <ul className="flex flex-col p-4 md:p-0 mt-4 font-poppins font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white">
                <li>
                  <a
                    href="#"
                    className="block py-2 px-3 rounded text-[#000000] md:bg-transparent  md:p-0 "
                    aria-current="page"
                  >
                    Home
                  </a>
                ...
                <li>
                  <a
                    href="#"
                    className="block py-2 px-3 text-[#000000] rounded hover:bg-gray-100 md:hover:bg-transparent  md:p-0"
                  >
                    About
                  </a>
                </li>
